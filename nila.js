(() => {
  ...
  document.addEventListener("click", (event) => {
    ...
    if (action === "next") nextSlide();
      ...
      transmission.textContent = "10011 · SIGNAL LOCKED";
      ...
      document.getElementById("finalAnswer").textContent = "Redundancy turns distance into survival—and every new channel creates a new mathematics problem.";
